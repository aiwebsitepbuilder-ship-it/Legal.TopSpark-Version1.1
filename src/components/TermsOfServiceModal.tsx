      ...
      >
        ...
        <div className="text-slate-600 text-sm leading-relaxed space-y-4 mb-8">
          <p className="font-bold text-slate-900 text-sm sm:text-base">
            Terms of Use — Top Spark Legal & Business Consultancy
          </p>

          <p>
            By accessing this platform, utilizing our AI Assistant, or scheduling a consultation, you agree to comply with these terms.
          </p>

          <p>
            <strong className="font-bold text-slate-900">1. Scope of Service:</strong>{' '}
            The website provides information and appointment scheduling for taxation, e-TIN, VAT, company incorporation, and legal documentation.
          </p>

          <p>
            <strong className="font-bold text-slate-900">2. Consultation Agreements:</strong>{' '}
            Appointment bookings submitted on the website represent requests for consultation and are confirmed upon formal verification by our legal team.
          </p>
        </div>
